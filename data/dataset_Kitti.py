...
class KITTIDataset(Dataset):
    ...
    def __init__(self, args, is_train=True):
        ...
        if is_train:
            with open('/data1/KITTI/eigen_train_files_with_gt.txt', 'r') as f:
                self.filenames = f.readlines()
            self.transform = transforms.Compose([ToTensor(mode='train')])

        else:
            with open('/data1/KITTI/eigen_test_files_with_gt.txt', 'r') as f:
                self.filenames = f.readlines()
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train: # for Training
            image_path = os.path.join('/data1/KITTI/', sample_path.split()[0])
            depth_path = os.path.join('/data1/KITTI/data_depth_annotated/', sample_path.split()[1])
            ...
            depth_gt = depth_gt / 256.0 # for KITTI
