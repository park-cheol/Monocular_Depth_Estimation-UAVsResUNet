...
import torch
from models.modules import ResidualConv, ASPP, AttentionBlock, Upsample_, Squeeze_Excite_Block


class ResUnetPlusPlus(nn.Module):
    def __init__(self, args, channel, filters=[32, 64, 128, 256, 512]):
    ...
    def forward(self, x):
        ...
        x9 = self.aspp_out(x8)
        out = self.output_layer(x9) * self.args.max_depth
